    ...
    root.innerHTML = `
      <div style="max-width:500px;margin:80px auto;font-family:monospace;color:#ccc">
        ...
        <details style="margin-top:16px">
          <summary style="color:#475569;font-size:12px;cursor:pointer">+ GitHub PAT (optional — enables commons access)</summary>
          ...
          <p style="color:#475569;font-size:11px;margin-top:6px">Stays in localStorage. Enables writing to GitHub repos — passport, commons, grains.</p>
        </details>
